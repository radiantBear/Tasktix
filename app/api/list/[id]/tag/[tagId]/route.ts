...
import { deleteTag, getIsListAssignee, getTagById, updateTag } from '@/lib/database/list';
import { getUser } from '@/lib/session';

export async function PATCH(request: Request, { params }: { params: { id: string, tagId: string } }) {
  ...
  if(!tag)
    return ClientError.BadRequest('Tag not found');
