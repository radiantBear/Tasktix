...
export default function DateInput({ autoFocus, label, placeholder, defaultValue, displayContent, color = 'default', className, value, onValueChange }: { autoFocus?: boolean, label?: string, placeholder?: string, defaultValue?: Date, displayContent?: ReactNode, color?: 'default'|'primary'|'secondary'|'danger'|'warning'|'success', className?: string, value?: Date, onValueChange?: (date: Date) => any }) {
